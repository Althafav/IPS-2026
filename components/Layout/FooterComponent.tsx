  ...
  return (
    <div className="relative ">
      ...
      <footer className="footer-component-wrapper ">
        <svg
          className="animated-streaming-module__PB4uha__pulse pulse"
        ...
        >
          <path
            stroke="url(#_R_92cjaubaaivb_)"
            stroke-linecap="round"
            stroke-width="1.881606931303395"
          ...
          <defs>
            <linearGradient
              ...
              id="_R_92cjaubaaivb_"
              x1="161.84300534951035"
              x2="87.77079369698185"
              y1="0"
              y2="-1.6687618909054436"
            >
